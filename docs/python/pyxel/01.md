...
Now that our floors have collision checking, we can modify the update function in `game.py` to use the collision checker.
...
And here's the update function in `game.py`. It gets the inputs and.
